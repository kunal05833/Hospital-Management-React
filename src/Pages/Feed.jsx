...
import { addPost,deletePost } from "../Slicer/PostSlicer";
import {
  Plus,
  X,
  Image,
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center text-gray-600">
                      <MessageSquare className="w-4 h-4 mr-2 mt-1.5" />
                  ...
                  <div className="flex justify-end space-x-4">
                    ...
                    <div className=" ">
                      <button
                        className="flex px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition "
                        onClick={() => handleDeletePost(post.id)} // Add delete functionality
                      >
                        <Trash height={17} className="mt-1" />
                        Delete
                      </button>
                    </div>
                    </div>
