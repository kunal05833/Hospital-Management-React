  ...
  return (
    <div className="ml-64 mt-2 p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        <div className="bg-white border rounded-lg shadow-md p-6 hover:shadow-xl transition-all group  border-gray-200">
        ...
        <div className="bg-white border rounded-lg shadow-md p-6 hover:shadow-xl transition-all group">
          ...
          <p className="text-gray-500 mb-4">Connect with doctors online very easily</p>
